...
import org.reynoldsm88.bigram.modeler.{BigramExtractor, ClasspathRulesProvider}
...
class ScalatraInit extends LifeCycle {
    ...
    override def init( context : ServletContext ) {
        ...
        val extractor : BigramExtractor = new DummyBigramExtactor() with ClasspathRulesProvider
